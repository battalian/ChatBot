# calendo
Give info about holidays and leaves
...
- Navigate to `calendo` folder
- Select `calendo.bot` file
...
msbot clone services --name "calendo" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
